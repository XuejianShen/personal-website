var RESEARCH_PROJECTS = [
  ...
  },
  {
    ...
    "category": "axions",
    "order": 2,
    "description": "A natural extension of axions to lower mass limit is fuzzy dark matter, whose mass can be as low as 10<sup>&minus;22</sup>eV. Quantum mechanical effects start to matter even at galactic scales (the de Broglie wavelength &lambda; &sim; kpc). This could have implications for solving small-scale \"crisis\" of &Lambda;CDM. In addition, the effective quantum pressure from fuzzy dark matter could wash out small-scale fluctuations in the initial power spectrum and affect early structure formation.",
    "paperLinks": [
      {
        "label": "Mocz+2020",
  ...
  },
  {
    ...
    "paperLinks": [
      {
        "label": "Shen+2023",
        "url": "https://ui.adsabs.harvard.edu/abs/2023MNRAS.525.3254S/abstract"
      },
      {
        "label": "Sun, Shen+2023",
  ...
  {
    "title": "Seeding SMBHs with Dissipative SIDM",
    "category": "smbh",
    "order": 2,
    "description": "Together with Huangyu Xiao at Fermi Lab, we consider the seeding of supermassive black holes (SMBHs) in the early Universe with dissipative dark matter. Our study showed that, with appropriate choice of parameters, a hit-and-stick type of dissipative dark matter (e.g. asymmetric dark matter nuggets) can collapse to massive SMBH seeds in rare, massive haloes, which could be the progenitors for the observed billion solar mass quasars at z&gtrsim;7. This exotic seeding scenario will give rise to completely different assembly history of early SMBHs and quasar activities. We are exploring the observational signatures in a follow-up study.",
    "paperLinks": [
      {
        "label": "Xiao & Shen 2021",
        "url": "https://ui.adsabs.harvard.edu/abs/2021JCAP...07..039X/abstract"
